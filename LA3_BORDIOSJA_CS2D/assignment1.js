...
// Use conditional ternary statements to assign grades to its value 
...
// Add another if..else if..else statements to assign the remarks
let remarks;
if (score >= 90){
...
// Log to the console the corresponding grade 
